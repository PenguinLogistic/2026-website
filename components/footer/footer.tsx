...
export default function Footer() {
  ...
  return (
    <section className="flex flex-col bg-blue-midnight gap-20 p-10 sm:p-20">
      <div className="flex flex-col w-full justify-center gap-6 sm:gap-0 sm:flex-row">
        <div className="flex flex-col gap-3 mx-auto justify-center">
          <Heading
            variant="h2"
            className="self-center sm:self-start text-white"
          >
            Ryan Fung
          </Heading>
        ...
        <div className="flex gap-4 items-center sm:items-start mx-auto flex-col">
